/**
 * Static nutrition lookup table — macros per 100g (or 100ml for liquids).
 * Values are approximate averages from USDA FoodData Central.
 * Keys are lowercase, used for fuzzy matching against ingredient names.
 */
...
const nutritionData: Record<string, NutritionPer100> = {
  ...
  "worcestershire":     { calories: 78,  protein: 0,   carbs: 20, fat: 0.1, fiber: 0 },
  ...
  // ── Herbs / Spices (negligible macros, small amounts) ─────────
