...
const macroStyles = StyleSheet.create({
  ...
  ingredientCard: { borderRadius: 12, padding: 12 },
  ingredientContentRow: { flexDirection: "row", justifyContent: "space-between", alignItems: "flex-start", gap: 10 },
  ...
  ingredientCalories: { fontSize: 14, fontFamily: "Inter_700Bold" },
  ingredientCaloriesUnit: { fontSize: 10, fontFamily: "Inter_600SemiBold" },
  ingredientBarTrack: { height: 4, borderRadius: 2, overflow: "hidden", marginTop: 10 },
  ingredientBarFill: { height: "100%", borderRadius: 2 },
  ingredientChipRow: { flexDirection: "row", gap: 6, marginTop: 8 },
  macroChip: { flexDirection: "row", alignItems: "center", gap: 4, borderRadius: 8, paddingHorizontal: 7, paddingVertical: 3 },
  macroChipText: { fontSize: 10, fontFamily: "Inter_600SemiBold" },
});
